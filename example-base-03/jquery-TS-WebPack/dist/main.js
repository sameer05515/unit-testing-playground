...
/***/ "./src/utils/global/globalConstants.ts":
/*!*********************************************!*\
  !*** ./src/utils/global/globalConstants.ts ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var globalConstants = (function () {
    var scriptNames = [
        ...
        { link: 'first-script.js' },
        { link: 'CSS-Flexbox-basics-01.js' }
    ];
    var SCRIPTS_OPTIONS = scriptNames.map(function (v) { return ({
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initialScript: () => (/* binding */ initialScript)
/* harmony export */ });
/* harmony import */ var _log_loggerUtility__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./log/loggerUtility */ "./src/utils/log/loggerUtility.ts");
/* harmony import */ var _global_globalConstants__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./global/globalConstants */ "./src/utils/global/globalConstants.ts");
// main.ts


var initialScript = function () {
    //===================== Utility Functions ====================
    var isValidSelectedScript = function (selectedScript) {
    ...
    var createElement = function (tag, attributes, innerHTML) {
    ...
    var createStyleElement = function (css, id) {
        var styleElement = createElement("style", { id: id || "" }, css);
    ...
    var clearExtraComponents = function () {
        var myMainDiv = document.getElementById("mathru-ki-bijli-ka-hindola");
        var chutiyonKiFauj = document.getElementById("chutiyon-ki-fauj");
        // Convert HTMLCollection to an array
        var bodyChildren = Array.from(document.body.children);
        bodyChildren.forEach(function (child) {
            if (child === myMainDiv ||
                ["meri-tag-line-wali-id-DO-NOT-DELETE", "chutiyon-ki-fauj", "mybase-script"].includes(child.id)) {
    ...
    var selectedPersonDiv = createElement("div");
    var select = createElement("select", { id: "mySelect" });
    var defaultOption = createElement("option", { disabled: "true", selected: "true" }, "Select Option");
    select.appendChild(defaultOption);
    _global_globalConstants__WEBPACK_IMPORTED_MODULE_1__["default"].SCRIPTS_OPTIONS.forEach(function (optionData, index) {
        var option = createElement("option", { value: index.toString() }, optionData.label);
        select.appendChild(option);
    });
    var selectedScript = null;
    var handleSelectOptionsChange = function (event) {
        clearExtraComponents();
        var target = event.target;
        var selectedOption = target.options[target.selectedIndex];
        selectedScript =
            _global_globalConstants__WEBPACK_IMPORTED_MODULE_1__["default"].SCRIPTS_OPTIONS[Number(selectedOption.value)].value;
        _log_loggerUtility__WEBPACK_IMPORTED_MODULE_0__["default"].info("[OPTION SELECTED]", selectedScript);
...
/***/ "./src/utils/log/loggerUtility.ts":
/*!****************************************!*\
  !*** ./src/utils/log/loggerUtility.ts ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _styles__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./styles */ "./src/utils/log/styles.ts");
/* harmony import */ var _validation__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./validation */ "./src/utils/log/validation.ts");
...
var LoggerUtility = function () {
    ...
    var createMessageSpan = function (type, logMessage) {
        if (logMessage === void 0) { logMessage = ''; }
        var span = document.createElement('span');
        (0,_styles__WEBPACK_IMPORTED_MODULE_0__.applyStyles)(span, (0,_styles__WEBPACK_IMPORTED_MODULE_0__.getStylesForType)(type));
        span.innerHTML = "<b>[".concat(type.toUpperCase(), "]: </b>[").concat(new Date().toString(), "]: ").concat(logMessage);
        return span;
    };
    var appendInnerHtmlToElement = function (message, logLevel) {
        if (!(0,_validation__WEBPACK_IMPORTED_MODULE_1__.validConfig)(registeredElement)) {
            return;
        }
        var messageSpan = createMessageSpan(logLevel, message.join(' '));
        registeredElement === null || registeredElement === void 0 ? void 0 : registeredElement.appendChild(messageSpan);
    };
    var resetInnerHtmlToElement = function () {
        if (!(0,_validation__WEBPACK_IMPORTED_MODULE_1__.validConfig)(registeredElement)) {
            return;
        }
        registeredElement.innerHTML = "<b>Logs to be displayed:-</b>";
    };
    var logToConsole = function (message, logLevel) {
        if (logLevel === void 0) { logLevel = 'info'; }
        if (logLevel && message.length > 0) {
            var logFunction = logLevel === 'error' ? console.error :
                logLevel === 'warn' ? console.warn :
                    logLevel === 'debug' ? console.debug :
                        console.log; // Default to console.log
            logFunction("[".concat(logLevel.trim().toUpperCase(), "]: [").concat(new Date(), "]: ").concat(message.join(' ')));
        }
    };
    var log = function (logLevel) {
        ...
        if (!validLogLevels.includes(logLevel.trim().toLowerCase())) {
            ...
            console.log("Invalid Message: '".concat(messages, "'. Unable to log message."));
            return;
        }
        if (logLevel === 'reset') {
            console.clear();
        ...
        appendInnerHtmlToElement(messages, logLevel); // Cast to StyleType
    };
    var info = function () {
        var messages = [];
        ...
        return log.apply(void 0, __spreadArray(['info'], messages, false));
    };
    var warning = function () {
        ...
        return log.apply(void 0, __spreadArray(['warn'], messages, false));
    };
    var success = function () {
        ...
        return log.apply(void 0, __spreadArray(['success'], messages, false));
    };
    var error = function () {
        var messages = [];
        for (var _i = 0; _i < arguments.length; _i++) {
        ...
        return log.apply(void 0, __spreadArray(['error'], messages, false));
    };
    var trace = function () {
        var messages = [];
        for (var _i = 0; _i < arguments.length; _i++) {
        ...
        return log.apply(void 0, __spreadArray(['trace'], messages, false));
    };
    var debug = function () {
        var messages = [];
        for (var _i = 0; _i < arguments.length; _i++) {
        ...
        return log.apply(void 0, __spreadArray(['debug'], messages, false));
    };
    var reset = function () { return log('reset', 'Console is about to be cleaned up'); };
    var registerLoggingConfig = function (element, elementId) {
        if (element) {
...
var getStylesForType = function (type) {
    ...
    switch (type) {
        ...
        case 'trace':
        case 'debug':
            return __assign(__assign({}, baseStyle), { color: 'red' });
        case 'warn':
            return __assign(__assign({}, baseStyle), { color: 'black', backgroundColor: 'yellow' });
        case 'info':
            return __assign(__assign({}, baseStyle), { color: 'blue' });
        case 'success':
            return __assign(__assign({}, baseStyle), { color: 'green' });
        default:
            return __assign({}, baseStyle);
    }
};
var applyStyles = function (element, styles) {
    ...
    for (var property in styles) {
        if (styles.hasOwnProperty(property)) {
            element.style[property] = styles[property]; // Type assertion
        }
    }
};
...
/* harmony export */ });
var validConfig = function (registeredElement) {
...
/***/ "./src/utils/services/apiService.ts":
/*!******************************************!*\
  !*** ./src/utils/services/apiService.ts ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _urlService__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./urlService */ "./src/utils/services/urlService.ts");
/* harmony import */ var _domService__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./domService */ "./src/utils/services/domService.ts");
// src/services/apiService.ts



var greetingClass = "greeting-id";
var contentClass = "greeting-content";
var jqxhrClass = "greeting-jqxhr";
var clickMe = function () {
    var nextUrl = (0,_urlService__WEBPACK_IMPORTED_MODULE_1__.getNextUrl)();
    (0,_domService__WEBPACK_IMPORTED_MODULE_2__.updateDom)(nextUrl, greetingClass, contentClass, jqxhrClass);
    jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
        url: nextUrl.url,
    }).then(function (data, status, jqxhr) {
        (0,_domService__WEBPACK_IMPORTED_MODULE_2__.displayResponse)(data, jqxhr, greetingClass, contentClass, jqxhrClass);
    });
};
...
/***/ "./src/utils/services/domService.ts":
/*!******************************************!*\
  !*** ./src/utils/services/domService.ts ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   displayResponse: () => (/* binding */ displayResponse),
...
var updateDom = function (nextUrl, greetingClass, contentClass, jqxhrClass) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".".concat(greetingClass)).empty().append("Refetching : " + nextUrl.name);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".".concat(contentClass)).empty();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".".concat(jqxhrClass)).empty();
};
var displayResponse = function (data, jqxhr, greetingClass, contentClass, jqxhrClass) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".".concat(greetingClass)).append(data.status || "status not received");
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".".concat(contentClass)).append(JSON.stringify(data, null, 2));
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".".concat(jqxhrClass)).append(JSON.stringify(jqxhr, null, 2));
};


/***/ }),

/***/ "./src/utils/services/urlService.ts":
/*!******************************************!*\
  !*** ./src/utils/services/urlService.ts ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _utils_services_apiService__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/services/apiService */ "./src/utils/services/apiService.ts");
/* harmony import */ var _utils_initial_script__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/initial-script */ "./src/utils/initial-script.ts");
// src/main.ts
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(function () {
    (0,_utils_initial_script__WEBPACK_IMPORTED_MODULE_3__.initialScript)();
    var element = jquery__WEBPACK_IMPORTED_MODULE_0___default()("#my-element");
    element.text("Hello, TypeScript with jQuery! : ".concat(new Date().toISOString()));
    // Correctly select the button and add a click event listener
    // $('#my-button-no-1').on('click', clickMe);
    var button = jquery__WEBPACK_IMPORTED_MODULE_0___default()("#my-button-no-1").get(0); // Get the native DOM element
    if (button) {
        // Attach the event listener
        button.addEventListener("click", _utils_services_apiService__WEBPACK_IMPORTED_MODULE_2__.clickMe);
