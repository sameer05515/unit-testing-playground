...
/*!**********************************************************************!*\
  !*** ./src/scripts/custom/elementAdderUtility-examples/custom0.1.js ***!
  \**********************************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _js_lib_utils_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../js/lib/utils.js */ "./src/js/lib/utils.js");
/* harmony import */ var _js_utils_element_add_elementAdderUtility_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../js/utils/element-add/elementAdderUtility.js */ "./src/js/utils/element-add/elementAdderUtility.js");
...
var createChildren = function createChildren() {
  var providedChildArray = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [1, 2];
  var parentElm = (0,_modules_util_elementAdderUtility_examples_elementUtility_js__WEBPACK_IMPORTED_MODULE_3__.createElementsArray)(providedChildArray.length, true);
...
var createHTMLElement = function createHTMLElement(element) {
  promiseChain = promiseChain.then(function () {
    return _js_utils_element_add_elementAdderUtility_js__WEBPACK_IMPORTED_MODULE_1__["default"].addElementWithPromise(element).then(function (createdElement) {
...
var createHTMLElementsFromArray = function createHTMLElementsFromArray(elementsArray) {
  ...
  promiseChain["catch"](function (error) {
    ...
    _js_utils_log_loggerUtility_js__WEBPACK_IMPORTED_MODULE_2__["default"].info("[".concat(new Date(), "]: Finished calculation for given set of array: ").concat(JSON.stringify(createdHTMLElementsIdArray, null, 2)));
  });
};
(0,_js_lib_utils_js__WEBPACK_IMPORTED_MODULE_0__.createConsoleAndRegisterMyId)(function (successResponse) {
  ...
  var arr = createChildren([2, 3, 2, 3, 1, 2]);
  _js_utils_log_loggerUtility_js__WEBPACK_IMPORTED_MODULE_2__["default"].info("createChildren: ", arr.length || 0);
  createHTMLElementsFromArray(arr);
});
/******/ })()
;
//# sourceMappingURL=custom0.1.js.map