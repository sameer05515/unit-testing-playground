...
/*!*********************************************************************!*\
  !*** ./src/scripts/custom/use-case-to-learn-promise/use-case-02.js ***!
  \*********************************************************************/
__webpack_require__.r(__webpack_exports__);
...
var fetchAndCombineData = function fetchAndCombineData() {
  fetchUsers().then(function (users) {
    var userAddressPromises = users.map(function (user) {
      return fetchUserAddress(user.id);
    });
    var postsPromise = fetchPostsForLast5Days();
    return Promise.all([Promise.all(userAddressPromises), postsPromise]).then(function (_ref) {
    ...
    var combinedData = _ref3.combinedData,
      posts = _ref3.posts;
    _js_utils_log_loggerUtility_js__WEBPACK_IMPORTED_MODULE_1__["default"].info('Combined Data with Addresses:', JSON.stringify(combinedData));
    _js_utils_log_loggerUtility_js__WEBPACK_IMPORTED_MODULE_1__["default"].info('Posts from last 5 days:', JSON.stringify(posts));
...
/******/ })()
;
//# sourceMappingURL=use-case-02.js.map