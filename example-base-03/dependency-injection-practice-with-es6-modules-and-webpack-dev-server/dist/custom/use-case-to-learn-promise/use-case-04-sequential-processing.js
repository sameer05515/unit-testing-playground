...
/*!*******************************************************************************************!*\
  !*** ./src/scripts/custom/use-case-to-learn-promise/use-case-04-sequential-processing.js ***!
  \*******************************************************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _js_lib_utils_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../js/lib/utils.js */ "./src/js/lib/utils.js");
/* harmony import */ var _js_utils_log_loggerUtility_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../js/utils/log/loggerUtility.js */ "./src/js/utils/log/loggerUtility.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function ownKeys(e, r) { var t = Object.keys(e); if (Object.getOwnPropertySymbols) { var o = Object.getOwnPropertySymbols(e); r && (o = o.filter(function (r) { return Object.getOwnPropertyDescriptor(e, r).enumerable; })), t.push.apply(t, o); } return t; }
function _objectSpread(e) { for (var r = 1; r < arguments.length; r++) { var t = null != arguments[r] ? arguments[r] : {}; r % 2 ? ownKeys(Object(t), !0).forEach(function (r) { _defineProperty(e, r, t[r]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : ownKeys(Object(t)).forEach(function (r) { Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r)); }); } return e; }
function _defineProperty(e, r, t) { return (r = _toPropertyKey(r)) in e ? Object.defineProperty(e, r, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : e[r] = t, e; }
...
var fetchUserAddress = function fetchUserAddress(userId) {
  return fetch("https://jsonplaceholder.typicode.com/users/".concat(userId)).then(function (response) {
    return response.json();
  }).then(function (user) {
    return user.address;
  });
};
var fetchPostsForLast5Days = function fetchPostsForLast5Days() {
  return fetch('https://jsonplaceholder.typicode.com/posts').then(function (response) {
    ...
    return posts.filter(function (post) {
      return new Date(post.date) >= fiveDaysAgo;
    });
  });
};
var fetchAddressesSequentially = function fetchAddressesSequentially(users) {
  return users.reduce(function (promiseChain, user) {
    return promiseChain.then(function (results) {
      return fetchUserAddress(user.id).then(function (address) {
        return [].concat(_toConsumableArray(results), [address]);
      });
    });
  }, Promise.resolve([]));
};
var fetchAndCombineData = function fetchAndCombineData() {
  fetchUsers().then(function (users) {
    var postsPromise = fetchPostsForLast5Days();
    return fetchAddressesSequentially(users).then(function (addresses) {
      return {
        users: users,
        addresses: addresses,
    ...
    var users = _ref.users,
      ...
      postsPromise = _ref.postsPromise;
    return postsPromise.then(function (posts) {
      var combinedData = users.map(function (user, index) {
    ...
    var combinedData = _ref2.combinedData,
      posts = _ref2.posts;
    _js_utils_log_loggerUtility_js__WEBPACK_IMPORTED_MODULE_1__["default"].info('Combined Data with Addresses:', combinedData);
    _js_utils_log_loggerUtility_js__WEBPACK_IMPORTED_MODULE_1__["default"].info('Posts from last 5 days:', posts);
    renderCards(combinedData);
  })["catch"](function (error) {
    _js_utils_log_loggerUtility_js__WEBPACK_IMPORTED_MODULE_1__["default"].error('Error:', error);
  });
};
var styles = {
  card: {
...
var renderCards = function renderCards(data) {
  ...
  var myContainerDiv = document.getElementById('premendra-kumar');
  ...
  data.forEach(function (item) {
    ...
    header.textContent = "User: ".concat(item.name);
    ...
    for (var key in item) {
      ...
      if (_typeof(value) === 'object') {
        ...
        paragraph.innerHTML = "<strong>".concat(key, ":</strong> ").concat(value);
...
var renderNestedFields = function renderNestedFields(key, obj) {
  var fragment = document.createDocumentFragment();
  var title = document.createElement('p');
  title.innerHTML = "<strong>".concat(key, ":</strong>");
  ...
  for (var nestedKey in obj) {
    ...
    nestedParagraph.innerHTML = "&nbsp;&nbsp;<strong>".concat(nestedKey, ":</strong> ").concat(nestedValue);
    applyStyles(nestedParagraph, _objectSpread(_objectSpread({}, styles.cardParagraph), styles.nestedField));
...
(0,_js_lib_utils_js__WEBPACK_IMPORTED_MODULE_0__.createConsoleAndRegisterMyId)(function (successResponse) {
  console.clear();
  var createdElementDiv = document.getElementById(successResponse.consoleDivId);
  createdElementDiv.style.width = "95%";
  _js_utils_log_loggerUtility_js__WEBPACK_IMPORTED_MODULE_1__["default"].info("[Success]: ", JSON.stringify(successResponse));
  //reshuffle();
}, function (errorMessage) {
  _js_utils_log_loggerUtility_js__WEBPACK_IMPORTED_MODULE_1__["default"].error("[Fail]: ", errorMessage);
}, function (LOGGERR) {
  _js_utils_log_loggerUtility_js__WEBPACK_IMPORTED_MODULE_1__["default"].reset();
  _js_utils_log_loggerUtility_js__WEBPACK_IMPORTED_MODULE_1__["default"].info("Console cleared.====================================================");
...
/******/ })()
;
//# sourceMappingURL=use-case-04-sequential-processing.js.map