...
/*!*********************************************************************!*\
  !*** ./src/scripts/custom/use-case-to-learn-promise/use-case-01.js ***!
  \*********************************************************************/
__webpack_require__.r(__webpack_exports__);
...
var combineUserDataAndPosts = function combineUserDataAndPosts(users, posts) {
...
var fetchAndCombineData = function fetchAndCombineData() {
  Promise.all([fetchUsers(), fetchPosts()]).then(function (_ref) {
    var _ref2 = _slicedToArray(_ref, 2),
      users = _ref2[0],
      posts = _ref2[1];
    var combinedData = combineUserDataAndPosts(users, posts);
    _js_utils_log_loggerUtility_js__WEBPACK_IMPORTED_MODULE_1__["default"].info('Combined Data:', JSON.stringify(combinedData, null, 1));
  })["catch"](function (error) {
...
/******/ })()
;
//# sourceMappingURL=use-case-01.js.map