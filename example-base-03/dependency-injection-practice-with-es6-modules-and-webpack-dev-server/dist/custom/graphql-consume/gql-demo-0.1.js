/******/ (() => { // webpackBootstrap
/*!************************************************************!*\
  !*** ./src/scripts/custom/graphql-consume/gql-demo-0.1.js ***!
  \************************************************************/
...
var myContainerEl = document.createElement('div');
var myHeaderContainerEl = document.createElement('div');
var myResumeContainerEl = document.createElement('div');
var fetchBtnEl = document.createElement('button');
fetchBtnEl.innerText = 'Fetch Data';
var showHidePreBtnEl = document.createElement('button');
showHidePreBtnEl.innerText = 'Show';
var myPreEl = document.createElement("pre");
...
var fetchData = function fetchData() {
  fetchGraphQL(query, variables).then(function (data) {
...
showHidePreBtnEl.addEventListener('click', function () {
  if (showPre) {
...
var personalDetails = {
  ...
  "emails": ["premendra.bce05515@gmail.com", "premendra.bce05515@outlook.com"],
  "contactNumbers": ["+91 80106 45624", "+91 87500 84750"]
};
function createPersonalDetailsCard(details, parentElement) {
  ...
  details.contactNumbers.forEach(function (contact) {
...
function createExpertiseCard(expertises, parentElement) {
  ...
  expertises.forEach(function (expertise) {
    ...
    stream.innerHTML = "<strong>Stream:</strong> ".concat(expertise.stream);
    var duration = document.createElement('p');
    duration.innerHTML = "<strong>Duration:</strong> ".concat(expertise.duration);
...
/******/ })()
;
//# sourceMappingURL=gql-demo-0.1.js.map