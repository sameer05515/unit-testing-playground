...
appRoot.controller("homeCtrl", function ($scope, $http) {
  ...
  $http({ method: "GET", url: "data/json/chapter-summary.json" }).then(
    function (response) {
...
appRoot.controller("chapterCtrl", function ($scope, $http, $routeParams, $log) {
  ...
  $http({ method: "GET", url: "data/json/chapter-verse-detail-temp.json" }).then(
    function (response) {
      $scope.chapterSummaryList = response.data;
...
appRoot.controller("wordMeaningCtrl", function ($scope, $http, $routeParams, $log) {
  ...
  $http({ method: "GET", url: "data/json/chapter-verse-word-meaning-temp.json" }).then(
    function (response) {
...
appRoot.controller("IndexCtrl", function ($scope) {
  $scope.Students = [
    { Id: "stud1", FirstName: "FirstName1", LastName: "LastName1" },
    { Id: "stud2", FirstName: "FirstName2", LastName: "LastName2" },
  ];
});
