...
import { ChapterSummary } from '../../models/gita.models';
import { GitaDataService } from '../../services/gita-data.service';

@Component({
  selector: 'app-home',
  standalone: true,
  imports: [NgIf, NgFor, RouterLink, AsyncPipe, NgOptimizedImage],
...
export class HomeComponent {
  ...
  readonly summaries$: Observable<ChapterSummary[]> =
    this.dataService.getChapterSummaries();
