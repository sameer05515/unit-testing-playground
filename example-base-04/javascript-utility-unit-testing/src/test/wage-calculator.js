...
const convertInrToDollars = (amount, exchangeRate = DEFAULT_EXCHANGE_RATE) => amount / exchangeRate;

// Convert Dollars to INR based on exchange rate
const convertDollarsToInr = (amount, exchangeRate = DEFAULT_EXCHANGE_RATE) => amount * exchangeRate;
